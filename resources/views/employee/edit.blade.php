         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="FatherName" value="{{ $employee->FatherName }}" class="form-control" placeholder="FatherName">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>EnglishName:</strong>
                    <input type="text" name="EnglishName" value="{{ $employee->EnglishName }}" class="form-control" placeholder="EnglishName">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>JobTitle:</strong>
                    <input type="text" name="JobTitle" value="{{ $employee->JobTitle }}" class="form-control" placeholder="JobTitle">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
