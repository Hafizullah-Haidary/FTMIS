...
module.exports = {
    ...
    // },
    // persian: {
    //     months: ['حمل', 'ثور', 'جوزا', 'سرطان', 'اسد', 'سنبله', 'میزان', 'عقرب', 'قوس', 'جدری', 'دلو', 'حوت'],
    ...
    persian: {
        months: ['Hamal', 'Sawar', 'Jawzaa', 'Sarataan', 'Asad', 'Sonbola', 'Mezaan', 'Aqrab', 'Qause', 'Jaday', 'Dalwa', 'Hoot'],
        monthsShort: ['Ham', 'Sawr', 'Jaw', 'Sar', 'Asad', 'Son', 'Mez', 'Aqr', 'Qaw', 'Jad', 'Dal', 'Ho'],
        weekdays: ['Saturday', 'Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'],
        weekdaysShort: ['Sat', 'Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri'],
        weekdaysMin: ['Sa', 'Su', 'Mo', 'Tu', 'We', 'Th', 'Fr'],
        persianDaysName: ['Hamal', 'Sawar', 'Jawzaa', 'Sarataan', 'Asad', 'Sonbola', 'Mezaan', 'Aqrab', 'Qause', 'Dalwa', 'Hoot']
    }
};
